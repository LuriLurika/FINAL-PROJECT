      ...
      <>
        ...
        <Form noValidate validated={validated} onSubmit={this.handleSubmit}>
          ...
          <Form.Group>
            ...
            <Form.Control required onChange={event => this.handleInputChange(event)} value={user.lastname} name="lastname" type="text" />
            <Form.Control.Feedback type="invalid"> Campo requerido </Form.Control.Feedback>
          </Form.Group>
          ...
          <Form.Group>
            ...
            <Form.Control required onChange={event => this.handleInputChange(event)} value={user.parent} name="parent" type="text" />
            <Form.Control.Feedback type="invalid"> Campo requerido </Form.Control.Feedback>
          </Form.Group>

          <Form.Group controlId="formBasicEmail">
            <Form.Label>Email </Form.Label>
            <Form.Control required onChange={event => this.handleInputChange(event)} value={user.email} name="email" type="email" />
            <Form.Control.Feedback type="invalid"> Campo requerido </Form.Control.Feedback>
          </Form.Group>

          <Form.Group controlId="formBasicPassword">
            <Form.Label>Username</Form.Label>
            <Form.Control required onChange={event => this.handleInputChange(event)} value={user.username} name="username" type="text" />
            <Form.Control.Feedback type="invalid">Campo requerido </Form.Control.Feedback>
          </Form.Group>
          ...
          {!user.id && (
            <Form.Group>
              ...
              <Form.Control required onChange={event => this.handleInputChange(event)} value={user.password} name="password" type="password" />
              <Form.Control.Feedback type="invalid">Campo requerido </Form.Control.Feedback>
            </Form.Group>
          )}
