...
const EventCard = ({ placeId, onHandleDelete, onHandleEdit, _id, title, description, participants, eventDate }) => {
    return (
      <Col md={3}>
        <Card>
          <Card.Body>
            <Card.Title>{title}</Card.Title>
            <Card.Body><Map visibleAddress={false} placeId={placeId}/></Card.Body >
